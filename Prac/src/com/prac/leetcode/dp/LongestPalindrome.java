	...
	public static int largestPalindrome(int n) {
        ...
        while (!palindromFound) {
            ...
            for (long i = upperBound; upperBound > lowerBound; i--) {
                // if n= 3 none of the factor of palindrom  can be more than 999 or less than square root of assumed palindrome 
//            	System.out.println("check palindrom/i > maxNumber:"+(palindrom/i > maxNumber)+" i * i < palindrom:"+(i * i < palindrom));
...
//            System.out.println(palindromFound+" palindromeFound"+" palindrome till now:"+palindrom);
