...
/*
You are given a large string. You need to cut the string into chunks such that each sub­string that you get is a palin­drome.
Remem­ber that each 1 length string is always a palin­drome. You need to find the min­i­mum num­ber of cuts that you need to make
such that each sub­string is a palindrome.
*/
